            ...
            >
                ...
                >
                    ...
                    <Input
                        ...
                        onChange={(e) => form.setFieldsValue({ownerName: e.target.defaultValue})}
                    />
                </Form.Item>
                <HocAdaptiveWrapper screenWidth={screenWidth}>
                    <Form.Item
                    ...
                    <Form.Item
                        name="StreetAround"
                        rules={[
                            {required: true, message: "Введите пересечение улиц"},
                        ]}
                    >
                        ...
                        <Input
                            ...
                            className={cls.AntdForm__InputNumber}
                            onChange={(e) => form.setFieldsValue({StreetAround: e.target.value})}
                        />
                    </Form.Item>
                </HocAdaptiveWrapper>
                <Form.Item
                    name="TagCoordination"
                >
                ...
                >
                    ...
                    <UploadComponent handleValueUpload={handleValueUpload} fileList={fileList} setFileList={setFileList}/>
                </Form.Item>
                <Form.Item>
